...
def register_human_blueprints(api: Api) -> None:
    ...
    from app.routes.data_service import data_service_blp
    ...
    from app.routes.cn_derivatives import cn_derivatives_bp
    ...
    registrations: list[tuple] = [
        ...
        (data_service_blp, "/api/data-service"),
        ...
        (cn_derivatives_bp, "/api/cn-derivatives"),
    ]
