...
expiry closest to ~45 DTE (28–65 window, roll at 21 DTE), computes GEX walls,
and shorts 14–25Δ call/put **outside** the walls with 3-step long wings.
Net credit must be at least 25% of wing width. Contracts are NEVER hard-coded.
...
# @param min_credit_to_width float 0.20 Skip thin credit / wing range=0:0.5:0.05
...
# @param require_high_iv bool 1 Require IV-rank ≥ 40 to sell premium
...
def handle_data(context, data):
    ...
    The engine, each bar:
      ...
      3. GEX walls → 14–25Δ shorts outside walls, 3-step listed wings, credit/width ≥ 25%
      4. size by 6% NAV risk cap (Kelly as a further cap) and roll at 21 DTE
