...
- Strategy V2 sandbox 需要显式、库里已有日 K 的合约代码。当前示例使用 50ETF 9 月链：`10010975/10010976/10010981/10010980`（购 3100/3200、沽 2900/2850）。合约过期后请换成 `qd_market_bars` 中仍有 bar 的代码。
